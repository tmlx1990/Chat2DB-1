package ai.chat2db.plugin.tdengine.builder;

import ai.chat2db.plugin.tdengine.type.TDengineColumnTypeEnum;
import ai.chat2db.plugin.tdengine.type.TDengineIndexTypeEnum;
...
public class TDengineSqlBuilder extends DefaultSqlBuilder implements SqlBuilder {
    @Override
    public String buildCreateTableSql(Table table) {
        ...
        for (TableColumn column : table.getColumnList()) {
            ...
            TDengineColumnTypeEnum typeEnum = TDengineColumnTypeEnum.getByType(column.getColumnType());
        ...
        for (TableIndex tableIndex : table.getIndexList()) {
            ...
            TDengineIndexTypeEnum mysqlIndexTypeEnum = TDengineIndexTypeEnum.getByType(tableIndex.getType());
    ...
    public String buildModifyTaleSql(Table oldTable, Table newTable) {
        ...
        for (TableColumn tableColumn : newTable.getColumnList()) {
            if (StringUtils.isNotBlank(tableColumn.getEditStatus()) && StringUtils.isNotBlank(tableColumn.getColumnType()) && StringUtils.isNotBlank(tableColumn.getName())) {
                TDengineColumnTypeEnum typeEnum = TDengineColumnTypeEnum.getByType(tableColumn.getColumnType());
