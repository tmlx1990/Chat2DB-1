...
public class TDengineMetaData extends DefaultMetaService implements MetaData {
    ...
    private List<String> systemDatabases = Arrays.asList("information_schema", "performance_schema");
    @Override
            ...
            while (resultSet.next()) {
                ...
                if (tableIndex != null) {
                    ...
                    if ("PRIMARY".equalsIgnoreCase(keyName)) {
                        index.setType(TDengineIndexTypeEnum.PRIMARY_KEY.getName());
                    } else {
                        index.setType(TDengineIndexTypeEnum.NORMAL.getName());
                    }
    ...
    public SqlBuilder getSqlBuilder() {
        return new TDengineSqlBuilder();
    }

    @Override
    public TableMeta getTableMeta(String databaseName, String schemaName, String tableName) {
        return TableMeta.builder()
                .columnTypes(TDengineColumnTypeEnum.getTypes())
                .charsets(TDengineCharsetEnum.getCharsets())
                .collations(TDengineCollationEnum.getCollations())
                .indexTypes(TDengineIndexTypeEnum.getIndexTypes())
                .defaultValues(TDengineDefaultValueEnum.getDefaultValues())
                .build();
    }
    ...
    public ValueHandler getValueHandler() {
        return new TDengineValueHandler();
    }
}
