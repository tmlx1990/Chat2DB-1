...
public enum TDengineIndexTypeEnum {
    ...
    TDengineIndexTypeEnum(String name, String keyword) {
        this.name = name;
    ...
    public static TDengineIndexTypeEnum getByType(String type) {
        for (TDengineIndexTypeEnum value : TDengineIndexTypeEnum.values()) {
    ...
    private String buildDropIndex(TableIndex tableIndex) {
        if (TDengineIndexTypeEnum.PRIMARY_KEY.getName().equals(tableIndex.getType())) {
            return StringUtils.join("DROP PRIMARY KEY");
        }
        return StringUtils.join("DROP INDEX `", tableIndex.getOldName(),"`");
    }
    public static List<IndexType> getIndexTypes() {
        return Arrays.asList(TDengineIndexTypeEnum.values()).stream().map(TDengineIndexTypeEnum::getIndexType).collect(java.util.stream.Collectors.toList());
    }
}
